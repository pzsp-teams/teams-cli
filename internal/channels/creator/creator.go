...
type ChannelCreator interface {
	Create(ctx context.Context, teamRef string, request map[string]ChannelData, ensureMembers, dryRun bool) []CreateResult
}
...
func (cc *channelCreator) Create(ctx context.Context, teamRef string, request map[string]ChannelData, ensureMembers, dryRun bool) []CreateResult {
