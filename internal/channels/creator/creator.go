...
type ChannelCreator interface {
	Create(ctx context.Context, teamRef string, request map[string]ChannelData, ensureMembersInChannel, ensureMembersInTeam, dryRun bool) []CreateResult
}
...
func (cc *channelCreator) Create(ctx context.Context, teamRef string, request map[string]ChannelData, ensureMembersInChannel, ensureMembersInTeam, dryRun bool) []CreateResult {
